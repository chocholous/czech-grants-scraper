"""
Sub-scraper for mzcr.cz (Ministry of Health / Ministerstvo zdravotnictví).
"""
...
class MZCrCzScraper(AbstractGrantSubScraper):
    """Scraper for mzcr.cz grant calls"""
    ...
    async def extract_content(self, url: str, grant_metadata: dict) -> Optional[GrantContent]:
        ...
        try:
            ...
            content = GrantContent(
                ...
                summary=title,
                funding_amounts=None,  # Often in PDF
                documents=documents,
    ...
    def _extract_description(self, soup: BeautifulSoup) -> Optional[str]:
        ...
        content_elem = soup.select_one('.entry-content, .article-content, main')
        if not content_elem:
            return None
    ...
    def _extract_documents(self, soup: BeautifulSoup, base_url: str) -> List[Document]:
        ...
        # Common patterns for attachment sections
