"""
Sub-scraper for mzv.cz (Ministry of Foreign Affairs / Ministerstvo zahraničních věcí).
"""
...
class MZVCzScraper(AbstractGrantSubScraper):
    """Scraper for mzv.cz grant calls"""
    ...
    def _extract_description(self, soup: BeautifulSoup) -> Optional[str]:
        ...
        # mzv.cz often uses .article_body or similar
        content_elem = soup.select_one('.article_body, .content, main')
        if not content_elem:
            return None
