"""
Sub-scraper for justice.cz (Ministry of Justice / Ministerstvo spravedlnosti).
"""
...
class JusticeCzScraper(AbstractGrantSubScraper):
    """Scraper for justice.cz grant calls"""
    ...
    def _extract_description(self, soup: BeautifulSoup) -> Optional[str]:
        ...
        # justice.cz often uses .content-body or similar
