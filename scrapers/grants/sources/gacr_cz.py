"""
Sub-scraper for gacr.cz (Grantova agentura Ceske republiky).

Extracts grant call content, documents, and basic metadata from gacr.cz pages.
"""
...
class GACRCzScraper(AbstractGrantSubScraper):
    """Scraper for gacr.cz grant call pages"""
    ...
    DOC_TYPE_PATTERNS = {
        "call_text": ["text vyzvy", "vyzva", "zadani", "call text"],
    ...
    def can_handle(self, url: str) -> bool:
        """Check if URL is from gacr.cz domain"""
        parsed = urlparse(url)
    ...
    async def extract_content(
        ...
        """Extract grant content from gacr.cz page"""
        try:
    ...
    async def download_document(self, doc_url: str, save_path: str) -> bool:
        """Download document from gacr.cz to local path"""
